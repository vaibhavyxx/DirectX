...
{
	material->LoadVertexShader();
	material->LoadPixelShader();
	...
	//  - Luckily, we already have that loaded (the vertex shader blob above)
	{
		...
		Graphics::Device->CreateInputLayout(
			...
			material->vertexShaderBlob->GetBufferPointer(),	// Pointer to the code of a shader that uses this layout
			material->vertexShaderBlob->GetBufferSize(),		// Size of the shader code that uses this layout
